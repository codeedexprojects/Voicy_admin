...
function ManageExecutiveDetail() {
  const { id } = useParams();

  const [open, setOpen] = useState(false);
  const ITEMS_PER_PAGE = 10;
  const [blockedUser, setBlockedUser] = useState(null); // State to store user details
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (error.response?.status === 404) {
        setError("Call History Not Found");
      } else {
    ...
    try {
      // Fetch statistics
      const statisticsData = await getSingleExecutivestatistics(id);
    ...
    try {
      // Fetch ratings
      const ratingData = await getExecutivecallRating(id);
 ...
 useEffect(() => {
  ...
  const downloadExcel = () => {
    ...
    const data = [
      { Title: "Total Earnings", Value: statistics.total_coins_balance },
      { Title: "off days", Value: statistics.total_days_offline + " Days" },
      { Title: "Total Rating", Value: statistics.total_rating },
  ...
  return (
    <>
      ...
      <div className="container  my-3">
        <Button
          onClick={() => navigate("/manage-executive")}
          variant="text"
          color="black"
        >
        ...
        <div className="row row2">
          ...
          {/* <div className="col-md-3 col-12">
                        <p>Image Preview</p>
                        <img alt='' className='employeePic' src='https://th.bing.com/th/id/OIP.EN9JF9Q4hfValEUlOcOY8wHaKA?w=540&h=730&rs=1&pid=ImgDetMain' />
                    </div> */}
          <div className="col-md-3 col-12">
            <MDBCard>
                ...
                <div>
                  ...
                  <MDBCardText>
                    <h4>
                      ...
                      {statistics && statistics.total_coins_balance !== null
                        ? statistics.total_coins_balance
                        : "N/A"}
                    </h4>
                  </MDBCardText>
                </div>
            ...
            <MDBCard>
              <MDBCardBody className="cardBody">
                ...
                <div>
                  ...
                  <MDBCardText>
                    <h4>
                      {statistics && statistics.total_days_offline !== null
                        ? statistics.total_days_offline + " Days"
                        : "N/A"}
                    </h4>
                  </MDBCardText>
                </div>
            ...
            <MDBCard className="card">
              <MDBCardBody className="cardBody">
                ...
                <div>
                  ...
                  <MDBCardText>
                    <h4>
                      {statistics && statistics.total_rating !== null
                        ? statistics.total_rating
                        : "N/A"}
                    </h4>
                  </MDBCardText>
                </div>
            ...
            <MDBCard>
              <MDBCardBody className="cardBody">
                ...
                <div>
                  ...
                  <MDBCardText>
                    <h4>{(talktime?.total_talktime_minutes ?? 0) + " Min"}</h4>
                  </MDBCardText>
                </div>
              </MDBCardBody>
            </MDBCard>
...
export default ManageExecutiveDetail;
